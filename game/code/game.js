...
Level.prototype.actorAt = function(actor) {
	for (var i=0; i<this.actors.length; i++) {
		...
		if (other != actor && 
			...
			actor.pos.y + actor.size.x > other.pos.y &&
...
Breakaway.prototype.act = function(step) {
...
var playerXSpeed = .5;
var playerMaxXSpeed = 10;

//Checks x movement, accelerates or deaccelerates
...
//Check what type of tile is directly under the player
function playerDeath() {
  this.pos = new Vector(6,12);
  this.speed.x = 0;
};

/*
function jelloTaken() {
  player.size = this.size = new Vector(1.2, 3.6);
  console.log('grow');
}
*/
